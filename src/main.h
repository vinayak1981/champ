...
static const int64 MAX_MONEY = 1000000000 * COIN;			// 100 mil
...
static const uint256 hashGenesisBlockOfficial("0x69f0a2c0062e2c854b6c1036ef8a27b153ed4d09e651d27a5a353c8814e47608");
static const uint256 hashGenesisBlockTestNet ("0x69f0a2c0062e2c854b6c1036ef8a27b153ed4d09e651d27a5a353c8814e47608");
...
public:
    ...
    {
        // champcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // champcoin: get transaction coin age
...
public:
    ...
    // champcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // champcoin: entropy bit for stake modifier if chosen by modifier
    ...
    // champcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // champcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // champcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // champcoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // champcoin: block index flags
    enum
    {
